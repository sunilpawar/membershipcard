  ...
  public static function get($params) {
    ...
    while ($template->fetch()) {
      $results[] = [
        ...
        'front_background_color' => $template->front_background_color,
        'back_background_color' => $template->back_background_color,
        'front_background_image' => $template->front_background_image,
        'back_background_image' => $template->back_background_image,
        'front_elements' => $template->front_elements,
        'back_elements' => $template->back_elements,
        'is_dual_sided' => $template->is_dual_sided,
        'is_active' => $template->is_active,
