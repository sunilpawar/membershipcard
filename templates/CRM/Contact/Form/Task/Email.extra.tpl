{literal}
  <script type="text/javascript">
    CRM.$(function($) {
      $('#form-layout-compressed_is_membership_card').insertAfter('#saveDetails').show();
...
<table id="form-layout-compressed_is_membership_card" class="form-layout-compressed"  style="display: none;">
  <tr id ="form-layout-compressed_is_membership_template_enabled" class="form-layout-compressed">
    <td class="label">{$form.is_membership_template_enabled.label}</td>
    <td>{$form.is_membership_template_enabled.html}</td>
  </tr>
